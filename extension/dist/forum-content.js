(() => {
  ...
  (function() {
    ...
    const NEGATIVE_REACTIONS = /* @__PURE__ */ new Set([16, 17, 29, 14, 3]);
    const POSITIVE_REACTIONS = /* @__PURE__ */ new Set([1, 2, 5, 26, 6, 7, 31, 22]);
    const POST_SELECTOR = "article.message";
